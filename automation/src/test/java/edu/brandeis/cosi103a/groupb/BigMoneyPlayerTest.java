...
public class BigMoneyPlayerTest {
    ...
    public void testAdvancedStrategySkipsFramework() {
        ...
        GameState state = new GameState(player.getName(), dummyHand, GameState.TurnPhase.BUY, 8, 1, deck);
    ...
    public void testAdvancedStrategySkipsFrameworkWithEngine() throws Exception {
        ...
        Engine engine = new GameEngine(player, opponent, observer);
        ...
        deckMap.put(Card.Type.FRAMEWORK, 1);  // Last Framework card available
        deckMap.put(Card.Type.ETHEREUM, 5);   // Alternative purchase option
        GameDeck controlledDeck = new GameDeck(deckMap);
        ...
        GameState state = new GameState(player.getName(), dummyHand, GameState.TurnPhase.BUY, 8, 1, controlledDeck);
